    ...
    internal class Program
    {
        public static void writedata()
        {
            FileStream fs = new FileStream
                (@"D:\GreatLearning\Day5Projects\FileHandlingConsole\wipro.txt",
                FileMode.Append, FileAccess.Write);
            Console.WriteLine("Enter something to append in the file ..");
        ...
        public static void readdata()
        {
            ...
            fs = new FileStream(@"D:\GreatLearning\Day5Projects\FileHandlingConsole\wipro.txt",
                FileMode.Open, FileAccess.Read);
            sr = new StreamReader(fs);
            sr.BaseStream.Seek(100, SeekOrigin.Begin);
